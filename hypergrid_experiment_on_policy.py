...
from gfn.utils.training import validate, visit_distribution
...
def main(args):  # noqa: C901
    ...
    for iteration in trange(n_iterations):
        ...
        if iteration % args.validation_interval == 0:
            ...
            if n_iterations-iteration<= args.validation_interval:
                # for the last iteration, we use sampling to approximate the model's policy and distributions
                validation_info, gflow_policy, ground_truth_policy, flow_map= validate(
                    env,
                    gflownet,
                ...
                validation_info, gflow_policy, ground_truth_policy ,_ = validate(
                env,
                gflownet,
                args.validation_samples,
    ...
    file_path = f'hypergrid_experiment_result_{args.ndim}_{args.height}_{args.R0}_{args.R1}_{args.R2}_rewardCosine.pkl'
    policy_path = f'hypergrid_experiment_result_{args.ndim}_{args.height}_{args.R0}_{args.R1}_{args.R2}_rewardCosine_policies.pkl'
    ...
    model_flow_map = f'hypergrid_experiment_result_{args.ndim}_{args.height}_{args.R0}_{args.R1}_{args.R2}_model_flow_map.pkl'
# Open the file in binary write mode and store the data using pickle.dump()
    ...
    with open(model_flow_map, 'wb') as file:
        pickle.dump(flow_map, file)
